...
meeting notes 8/21
34x45 as dump for leukocyte progenitors
CD15 is grans, low is monos
trans are CD5 low
CD10 confirms transitinal
get rid of APC-CD64?
add CD185 (CXCR5)?
...
- lookup titration for CXCR5

- look at single colors for look at kappa vs IgA, all red laser fluors against eachoother, include CD20, R720 should peak in 700ish off the red

- double check BV510 and BUV496

- make R720 plots

- Add CLL unstained to matrix

- check on the instrument, make sure it's still passing QC

- make Bcellonly mini-matrix for iteration_3, upload, organize the box
